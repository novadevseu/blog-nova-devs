...
function PostContainer({ id, setError }: PostContainerInterface) {
  ...
  return (
    <article className="mt-20 p-8 rounded-lg w-full max-w-4xl mx-auto bg-[#090d1f]/50 backdrop-blur-sm shadow-lg border border-[#E0C600]/10 transition-all duration-300">
      {/* Title */}
      ...
      {/* Imagen Destacada */}
      {post?.thumbnailUrl && (
        <div className="relative w-full h-64 md:h-[400px] mb-8 overflow-hidden rounded-lg shadow-lg border border-gray-800">
          <Image
      ...
      {userRole === "Admin" && (
        <div className="mb-8 flex justify-end">
          <button
            ...
            className="px-6 py-3 bg-[#E0C600] text-[#090d1f] rounded-lg font-semibold transition-all duration-300 hover:bg-[#E0C600]/90 hover:scale-105 shadow-[0_0_15px_rgba(224,198,0,0.3)] hover:shadow-[0_0_20px_rgba(224,198,0,0.4)] flex items-center gap-2"
          >
            <span>✏️</span>
            Editar Post
          </button>
      ...
      {/* Content */}
      <div className="markdown-content mb-8 prose prose-invert prose-yellow max-w-none prose-pre:bg-[#0c1023] prose-pre:border prose-pre:border-gray-800/50 prose-headings:text-white prose-headings:font-bold prose-a:text-[#E0C600] prose-a:no-underline hover:prose-a:underline prose-strong:text-[#E0C600] prose-code:text-[#E0C600]">
